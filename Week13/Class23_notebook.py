...
expected_y_grid = M_grid[..., None] * x_vals + B_grid[..., None] #TJ create grid of expected y_values for all the combinations of guesses
...
chi2_grid #TJ show the grid... it doesnt look pretty, but it's there
